...
from resonantforge.schemas import ConversationRecord, KBChunk, TrajectoryRow
...
class CrossContaminationInjector:
    ...
    def contaminate_kb_chunks(self, chunks: Sequence[KBChunk]) -> list[KBChunk]:
        ...
        ----------
        chunks:
            KB chunk objects to process.  Must be :class:`~resonantforge.schemas.KBChunk`
            instances.
    ...
    def contaminate_trajectory_rows(
        ...
        rows:
            ...
            :class:`~resonantforge.schemas.TrajectoryRow` instances.
    ...
    def contaminate_conversations(
        ...
        convs:
            ...
            :class:`~resonantforge.schemas.ConversationRecord` instances.
